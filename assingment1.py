...
if b>a:
    if b>c:
         print("second number is gretest",b)
if c>a:
    if c>b:
        print("third the number is greater",c) 
...
if (num%5==0) and(num%11==0):
    print("the number is completely dvisible by 5 and 11")
else:
    print("the number is not completely dvisible by 5 and 11")
